...
starters_data = {
    ...
    'Player': [
        ...
        "Shai Gilgeous-Alexander", "Aaron Wiggins", "Jalen Williams", "Luguentz Dort", "Chet Holmgren", "Isaiah Joe", "Alex Caruso", "Isaiah Joe", "Isaiah Joe",
        ...
        "Tyrese Maxey", "Kyle Lowry", "Caleb Martin", "Kelly Oubre Jr.", "Andre Drummond", "Eric Gordon", "Guerschon Yabusele", "Guerschon Yabusele", "Guerschon Yabusele",
